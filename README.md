...
　　○ プロダクトの方針をジャッジできるようなテックリードになりたい。なんらかの言語のコミッターになりたい。（PythonかGOを検討中）
...
| AWS資格試験 | ６ヶ月以上 |  ソリューションアーキテクトアソシエイト試験勉強　１１月に受験予定。クラウドプラクティショナーには合格。connpassのAWSハンズオンイベントが印象に残っておすすめ |
...
| Go | 数日 | 『詳解Go言語Webアプリケーション開発』　著者：清水陽一郎　を読んで学習。この言語に可能性を感じている自分がいる。 |
