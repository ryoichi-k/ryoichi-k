...
| AWS資格試験 | ６ヶ月以上 |  ソリューションアーキテクトアソシエイト試験勉強　９月に受験予定。クラウドプラクティショナーには合格。connpassのAWSハンズオンイベントが印象に残っておすすめ |
...
| アルゴリズム実技検定 | 2ヶ月以上 | アルゴリズムの学習は大好きだが、この検定は難易度が高いので、paizaラーニングと並行する予定。（現在はストップ） |
