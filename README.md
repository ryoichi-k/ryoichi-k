...
将来の夢は技術書を出版し、理工学書でベストセラーをとることです！

### サマリー

＼バックエンドエンジニアやっています！／

・入社してから、宿泊サイト、ナイトレジャー検索サイト、総合買取専門ECサイト、輸入雑貨ECサイトの開発案件に従事し、フロントエンドとバックエンドの両方を担ってきました。
...
輸入雑貨ECサイト（新規開発）、買取サイトの開発・改修、ナイトレジャー専門検索サイトの改修など　※出社、リモート併用、フルリモートでの業務の経験あり。
