...
　　○ プロダクトの方針についてジャッジできるようなテックリードになりたい。Goのコミッターになりたい。

## 💬サマリー

＼フルスタックエンジニアやっています！／

● 某国立大学を卒業後、情シス、SESを経て、現在自社開発企業に勤務。
...
● 開発言語:Go、PHP、Python3、JavaScript、TypeScriptなど
...
　　○ 要件定義～テスト（基本設計書、単体テスト仕様書、データベース定義書の作成経験あり）
